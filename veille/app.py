# Page d'accueil de la veille techno (certification Simplon). Le reste
# du contenu est dans veille/pages/ (Streamlit gere la nav multi-pages
# automatiquement a partir de ce dossier).
